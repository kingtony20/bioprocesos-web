...
export default function LoginGerente() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Guardar datos del gerente (ajusta según lo que devuelva tu API)
    ...
    <main className="min-h-screen bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200 flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600 mt-2">Acceso Gerente</p>
        </div>
        ...
        <p className="text-center text-sm text-gray-500 mt-8">
          Área exclusiva para gerencia • Bio Procesos Industriales
        </p>
      </div>
    </main>
  );
